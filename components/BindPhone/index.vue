		...
		<view class="bindPhone">
			...
			<view class="bindPhone_main">
				<view class="bindPhone_main_inputBox">
					<up-input class="bindPhone_main_input" clearable border="bottom" :placeholder="UserStore.userInfo.phone || '+86 | 手机号码'" v-model="phone"></up-input>
				</view>

				<view class="bindPhone_main_inputBox">
					<up-input class="bindPhone_main_input" clearable border="bottom" placeholder="请输入验证码" v-model="passWord"></up-input>
