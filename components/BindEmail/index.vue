		...
		<view class="bindPhone">
			...
			<view class="bindPhone_main">
				<view class="bindPhone_main_inputBox">
					<up-input class="bindPhone_main_input" clearable border="bottom" placeholder="+86 | 手机号码"
						v-model="phone"></up-input>
				</view>
			...
			<view class="bindPhone_footer">
				<view class="bindPhone_footer_button" @click="onsendEmail">
					确定
				</view>
			</view>
		</view>
