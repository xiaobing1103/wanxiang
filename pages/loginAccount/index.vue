				...
				<view class="loginAccount_main">
					<view class="loginAccount_main_input">
						<up-input
							...
							:placeholder="type == 'phone' ? '请输入手机号' : '请输入邮箱或用户名'"
							border="surround"
					...
					<view class="loginButton">
						<up-button size="small" :customStyle="{ width: '100%', borderRadius: '35rpx', marginTop: '30rpx' }" @click="onLogin" type="primary" text="确定"></up-button>
					</view>
				</view>
			</template>
			<up-overlay :show="show">
				<view class="warp">
					<up-loading-icon vertical color="#e8e8e8" text-color="#e8e8e8" text="登录中" textSize="18"></up-loading-icon>
				</view>
			</up-overlay>
		</z-paging>
	</view>
