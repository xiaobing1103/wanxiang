...
<script setup lang="ts">
	...
	const newMenuLists = reactive({
		...
		"AI音乐": [
			...
			// {
			// 	cover: $assets.ImageCreateMusicIcon,
			// 	title: 'AI图片创作音乐',
			// 	description: '上传图片，就可以生成音乐',
			// 	path: '/pages/function/subPage/ImageCreateMusic/index'
			// },
			// {
			// 	cover: $assets.VideoCreateMusicIcon,
			// 	title: 'AI视频创作音乐',
			// 	description: '上传视频即可生成音乐',
			// 	path: '/pages/function/subPage/VideoCreateMusic/index'
			// },
		],
		"AI视频": [
			{
