<template>
	<view class="v-sign-action" :style="[customStyle]">
		<view v-for="item in btns" :key="item.label" :class="['btn', { border: border }]"
			:style="[{ 'margin-right': formatSize(space) }]" @click="onBtnClick(item)">
...
<script>
	...
	const btnsConf = [{
			...
			icon: '//file.1foo.com/2024/08/19/c08aa0d862064ea1e84adda853642c12.svg'
		},
		{
			label: '撤回',
			action: btn_type.PREV,
			icon: "//file.1foo.com/2024/08/19/85ede2b2b8699696318f094852f8c9ff.svg"
		},
		// {
		// 	label: '取消撤回',
		...
		// },
		{
			...
			icon: '//file.1foo.com/2024/08/19/4a8c213fb4e747196cb1942f4f242e02.svg'
		}
	]
	export default {
		name: 'v-sign-action',
