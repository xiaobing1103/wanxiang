...
<script setup lang="ts">
	...
	onMounted(() => {
		const index = drawStore.taskIdParmas.txt2img_task_json.historyTasks.length
		if (index > 0) {
			currentImages.value = drawStore.taskIdParmas.txt2img_task_json.historyTasks[index - 1] as drawTaskJson
