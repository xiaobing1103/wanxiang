<template>
	<template v-if="IamgeTypes.historyType !== 'txt2img_task_json'">
		<ImageUpload v-model:showUpOverlay="showUpOverlay" v-model:parmas="parmas" v-model:url="url"
			:type="IamgeTypes.historyType" ref="ImageUploadRef" />
	</template>
	<PreviewImageArae v-model:parmas="parmas" />
	<UseAiChatConfirm v-model:parmas="parmas" />
	<template v-if="IamgeTypes.historyType == 'txt2img_task_json' ">
