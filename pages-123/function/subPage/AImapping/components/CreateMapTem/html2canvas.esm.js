...
const prefixLinearGradient = function(context, tokens) {
	...
	parseFunctionArgs(tokens).forEach(function(arg, i) {
		if (i === 0) {
			const firstToken = arg[0]
			if (
				firstToken.type === 20 /* IDENT_TOKEN */ && ['top', 'left', 'right', 'bottom'].indexOf(
					firstToken.value) !==
				-1
			) {
				angle$1 = parseNamedSide(arg)
...
var parseNodeTree = function(context, node, parent, root) {
	for (
		let childNode = node.firstChild, nextNode = void 0; childNode; childNode = nextNode
	) {
...
const ElementPaint = /** @class */ (function() {
	...
	ElementPaint.prototype.getEffects = function(target) {
		let inFlow = [2 /* ABSOLUTE */ , 3 /* FIXED */ ].indexOf(
	...
	if (
		...
		if (hasIntrinsicValue(intrinsicProportion)) {
			...
			return targetRatio < intrinsicProportion !==
				(first.value === BACKGROUND_SIZE.COVER) ? [bounds.width, bounds.width / intrinsicProportion] : [
		...
		return __generator(this, function(_u) {
			switch (_u.label) {
				case 0:
					...
					resourceOptions = {
						allowTaint: (_b = opts.allowTaint) !== null && _b !== void 0 ?
							_b : false,
						imageTimeout: (_c = opts.imageTimeout) !== null && _c !== void 0 ?
							_c : 15000,
						proxy: opts.proxy,
						useCORS: (_d = opts.useCORS) !== null && _d !== void 0 ?
							_d : false
					}
					contextOptions = __assign({
							logging: (_e = opts.logging) !== null && _e !== void 0 ?
								_e : true,
							cache: opts.cache
						},
						resourceOptions
					...
					windowOptions = {
						windowWidth: (_f = opts.windowWidth) !== null && _f !== void 0 ?
							_f : defaultView.innerWidth,
						windowHeight: (_g = opts.windowHeight) !== null && _g !== void 0 ?
							_g : defaultView.innerHeight,
						scrollX: (_h = opts.scrollX) !== null && _h !== void 0 ?
							_h : defaultView.pageXOffset,
						scrollY: (_j = opts.scrollY) !== null && _j !== void 0 ?
							_j : defaultView.pageYOffset
					}
					...
					foreignObjectRendering =
						...
						false
					cloneOptions = {
						allowTaint: (_l = opts.allowTaint) !== null && _l !== void 0 ?
							_l : false,
				...
				case 1:
					...
					renderOptions = {
						...
						scale: (_o =
							...
							_o !== void 0 ?
							_o : 1,
						x: ((_p = opts.x) !== null && _p !== void 0 ? _p : 0) +
							left,
						y: ((_q = opts.y) !== null && _q !== void 0 ? _q : 0) +
							top,
						width: (_r = opts.width) !== null && _r !== void 0 ?
							_r : Math.ceil(width),
						height: (_s = opts.height) !== null && _s !== void 0 ?
							_s : Math.ceil(height)
					}
